...
func (host *Host) rebuildLocked(cfg serverconfig.Config) error {
	...
	host.mux = server.New(
		...
		server.POST("/oauth/token",
			...
			server.HTTP(),
			server.Local(upstream.OAuthTokenAction(routeDeps, host.configs)),
			server.Upstream(upstream.OAuthTokenAction(routeDeps, host.configs)),
		),
		...
		cursorCloudUpstreamProcedure("/aiserver.v1.AiService/StreamCpp", "ai_stream_cpp", server.ConnectStream(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.AiService/StreamNextCursorPrediction", "ai_stream_next_cursor_prediction", server.ConnectStream(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.AiService/GetCppEditClassification", "ai_get_cpp_edit_classification", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.AiService/RefreshTabContext", "ai_refresh_tab_context", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.AiService/CppConfig", "ai_cpp_config", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.AiService/CppEditHistoryStatus", "ai_cpp_edit_history_status", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.AiService/CppAppend", "ai_cpp_append", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.AiService/CppEditHistoryAppend", "ai_cpp_edit_history_append", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.AiService/ReportAiCodeChangeMetrics", "ai_report_ai_code_change_metrics", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.AiService/WriteGitCommitMessage", "ai_write_git_commit_message", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.AiService/WriteGitBranchName", "ai_write_git_branch_name", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		...
		cursorCloudUpstreamProcedure("/aiserver.v1.CppService/AvailableModels", "cpp_available_models", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.CppService/RecordCppFate", "cpp_record_cpp_fate", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		...
		cursorCloudUpstreamProcedure("/aiserver.v1.FileSyncService/FSSyncFile", "file_sync_sync_file", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.FileSyncService/FSIsEnabledForUser", "file_sync_is_enabled_for_user", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.FileSyncService/FSConfig", "file_sync_config", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.FileSyncService/FSUploadFile", "file_sync_upload_file", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		...
		// Plugins / marketplace: local mode still needs Cursor cloud so UI can show
		// Claude-imported plugin skills, MCP servers, and hooks metadata.
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/GetEffectiveUserPlugins", "dashboard_get_effective_user_plugins", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/ListMarketplaces", "dashboard_list_marketplaces", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/AddMarketplace", "dashboard_add_marketplace", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/RemoveMarketplace", "dashboard_remove_marketplace", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/UpdateMarketplace", "dashboard_update_marketplace", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/RefreshMarketplace", "dashboard_refresh_marketplace", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/RegisterMarketplaceAndPlugins", "dashboard_register_marketplace_and_plugins", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/ListMarketplacePlugins", "dashboard_list_marketplace_plugins", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/ResolvePluginsByRef", "dashboard_resolve_plugins_by_ref", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/GetPlugin", "dashboard_get_plugin", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/ListUserPluginInstalls", "dashboard_list_user_plugin_installs", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/InstallUserPlugin", "dashboard_install_user_plugin", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/UpdateUserPluginInstall", "dashboard_update_user_plugin_install", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/UninstallUserPlugin", "dashboard_uninstall_user_plugin", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/ListTeamPluginInstalls", "dashboard_list_team_plugin_installs", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/InstallTeamPlugin", "dashboard_install_team_plugin", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/UninstallTeamPlugin", "dashboard_uninstall_team_plugin", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/GetPluginMcpConfig", "dashboard_get_plugin_mcp_config", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
		cursorCloudUpstreamProcedure("/aiserver.v1.DashboardService/AddMcpServersFromPlugin", "dashboard_add_mcp_servers_from_plugin", server.ConnectUnary(), routeDeps, host.configs, upstream.CursorCloudRouteOptions{AllowLegacyTabServer: true}),
...
func cursorCloudUpstreamProcedure(
	pattern string,
	name string,
	protocol server.RouteOption,
	deps upstream.Dependencies,
	configs *serverconfig.Manager,
	opts upstream.CursorCloudRouteOptions,
) server.Option {
	action := upstream.CursorCloudDirectAction(deps, configs, configs.CursorTokens(), upstream.CompatRouteConfig{Name: name}, opts)
	return server.POST(pattern,
		server.Name(name),
		protocol,
		server.Local(action),
